...
class store_test extends \cachestore_tests {
    ...
    protected function tearDown(): void {
        ...
        if ($this->store instanceof cachestore_redissentinel) {
            $this->store->purge();
        }
    }
     ...
     * @return cachestore_redissentinel
     */
    protected function create_cachestore_redissentinel(array $extraconfig = [], bool $ttl = false): cachestore_redissentinel {
        if ($ttl) {
    ...
    public function test_has(): void {
        $store = $this->create_cachestore_redissentinel();
    ...
    public function test_get_last_io_bytes_compressed(): void {
        $store = $this->create_cachestore_redissentinel(['compressor' => cachestore_redissentinel::COMPRESSOR_PHP_GZIP]);
    ...
    public function test_delete_many(bool $ttl): void {
        $store = $this->create_cachestore_redissentinel([], $ttl);
