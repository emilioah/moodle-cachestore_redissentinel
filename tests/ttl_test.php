...
class ttl_test extends \advanced_testcase {
    /** @var \cachestore_redissentinel|null Cache store  */
    ...
    public function setUp(): void {
        ...
        $this->store = new \cachestore_redissentinel('Test', \cachestore_redissentinel::unit_test_configuration());
    ...
    public function test_expire_ttl(): void {
        ...
        \cachestore_redissentinel::set_phpunit_time(100);
        $this->store->set('a', 1);
        $this->store->set('b', 2);
        ...
        \cachestore_redissentinel::set_phpunit_time(110);
        $this->store->set('b', 2);
        ...
        \cachestore_redissentinel::set_phpunit_time(115);
